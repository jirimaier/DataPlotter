...
void MainWindow::initSetables() {
    ...
    setables["guistyle"] = ui->comboBoxStyle;
    setables["termfont"] = ui->comboBoxTerminalFont;
...
QByteArray MainWindow::getSettings() {
    ...
    if (ui->radioButtonLayoutHide->isChecked())
        settings.append("sidepanel:hide;\n");
    else if (ui->radioButtonLayoutWide->isChecked())
        settings.append("sidepanel:wide;\n");
    else if (ui->radioButtonLayoutSmall->isChecked())
        settings.append("sidepanel:small;\n");
...
void MainWindow::useSettings(QByteArray settings, MessageTarget::enumMessageTarget source = MessageTarget::manual) {
    ...
    if (settings == "clearlog") {
        ...
        if (setables.contains(type))
            ...
            if (value == "hide")
                ui->radioButtonLayoutHide->setChecked(true);
            if (value == "wide")
                ui->radioButtonLayoutWide->setChecked(true);
            if (value == "small")
                ui->radioButtonLayoutSmall->setChecked(true);
        }

        else if (type == "termsize") {
            if (value == "nb") {
                ui->radioButtonLayoutSmall->setChecked(true);
                ui->comboBoxTerminalFont->setCurrentIndex(0);
            } else if (value == "ns") {
                ui->radioButtonLayoutSmall->setChecked(true);
                ui->comboBoxTerminalFont->setCurrentIndex(1);
            } else if (value == "wb"){
                ui->radioButtonLayoutWide->setChecked(true);
                ui->comboBoxTerminalFont->setCurrentIndex(0);
            } else if (value == "ws"){
