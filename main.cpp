...
int main(int argc, char *argv[]) {
  ...
  NewSerialParser *serialParser1 = new NewSerialParser;
  NewSerialParser *serialParserM = new NewSerialParser;
  ...
  QObject::connect(&mainWindow, &MainWindow::requestSerialBufferClear, serialParserM, &NewSerialParser::clearBuffer);
  QObject::connect(&mainWindow, &MainWindow::requestSerialBufferShow, serialParserM, &NewSerialParser::showBuffer);
  QObject::connect(&mainWindow, &MainWindow::setSerialMessageLevel, serialParserM, &NewSerialParser::setMsgLevel);
